...
import com.example.fancy.Adapter.ProductsAdapter
...
class ManageProductsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        productsAdapter = ProductsAdapter(this, productsList, object : ProductsAdapter.OnItemClickListener {
    ...
    private fun addEditProduct() {
        ...
        if (productName.isNotEmpty() && productPrice.isNotEmpty()) {
            ...
            if (existingProduct != null) {
                updateProduct(existingProduct.prodId.toString(), product)
            } else {
                addProduct(product)
            }
        } else {
    ...
    private fun deleteProduct() {
        ...
        if (selectedProduct != null) {
            databaseReference.child(selectedProduct.prodId.toString())
                .removeValue()
                .addOnSuccessListener {
